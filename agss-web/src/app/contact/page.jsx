        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-24">
          <div>
            ...
            <p className="text-lg text-slate-600 mb-10 leading-relaxed">
              Ready to strengthen your maturity? Don&apos;t wait for a data
              breach or system failure. Fill out the form to get started with a
              consultation tailored to your factory&apos;s needs.
            </p>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-slate-500">
                    Identify immediate threats to your production line.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-slate-500">
                    Check your standing against PDPA and NIST standards.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-slate-500">
                    A clear 4-year plan tailored to your budget.
                  </p>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 focus:outline-none bg-slate-50 transition-all font-medium placeholder-slate-500"
        ...
        <div className="bg-slate-50 p-8 md:p-12 rounded-[2.5rem] border border-slate-100 shadow-sm relative overflow-hidden">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-slate-600">
              Drop by our headquarters to discuss how we can secure and
              modernize your manufacturing IT infrastructure.
            </p>
          </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="https://lin.ee/NgXqwZV"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-cyan-600 hover:text-cyan-700 font-medium transition-colors mt-1 block"
                  >
                    Add us on LINE
                  </a>
                </div>
